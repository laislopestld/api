...
async def main():
    ...
    for product in products:
        ...
        try:
            ...
            # Com o modelo mais barato, há menor risco de exceder limites de custo
            wait_time = random.uniform(30, 60)  # Reduzido para 30-60 segundos com o modelo mais eficiente
            ...
            if "rate limit" in str(e).lower():
                wait_time = 90  # Reduzido para 90 segundos com o modelo mais eficiente
                print(f"Erro de rate limit detectado. Aguardando {wait_time} segundos...")
                time.sleep(wait_time)
    
    # Salva resultados finais em um arquivo JSON que o n8n pode consumir
